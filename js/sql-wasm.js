  ...
  initSqlJsPromise = new Promise(function (resolveModule, reject) {
    ...
    e.onRuntimeInitialized = function () {
      ...
      var d = x(4),
        ...
        I = f('sqlite3_normalized_sql', 'string', ['number']),
        ba = f('sqlite3_prepare_v2', 'number', [
          'number',
          'number',
          'number',
          'number',
        ...
        jc = f('sqlite3_bind_double', 'number', ['number', 'number', 'number']),
        kc = f('sqlite3_bind_int', 'number', ['number', 'number', 'number']),
        lc = f('sqlite3_bind_parameter_index', 'number', ['number', 'string']),
        mc = f('sqlite3_step', 'number', ['number']),
        nc = f('sqlite3_errmsg', 'string', ['number']),
        oc = f('sqlite3_column_count', 'number', ['number']),
        pc = f('sqlite3_data_count', 'number', ['number']),
        qc = f('sqlite3_column_double', 'number', ['number', 'number']),
        rb = f('sqlite3_column_text', 'string', ['number', 'number']),
        rc = f('sqlite3_column_blob', 'number', ['number', 'number']),
        sc = f('sqlite3_column_bytes', 'number', ['number', 'number']),
        tc = f('sqlite3_column_type', 'number', ['number', 'number']),
        uc = f('sqlite3_column_name', 'string', ['number', 'number']),
        vc = f('sqlite3_reset', 'number', ['number']),
        wc = f('sqlite3_clear_bindings', 'number', ['number']),
        xc = f('sqlite3_finalize', 'number', ['number']),
        yc = f(
        ...
        zc = f('sqlite3_value_type', 'number', ['number']),
        Ac = f('sqlite3_value_bytes', 'number', ['number']),
        Bc = f('sqlite3_value_text', 'string', ['number']),
        Cc = f('sqlite3_value_blob', 'number', ['number']),
        Dc = f('sqlite3_value_double', 'number', ['number']),
        Ec = f('sqlite3_result_double', '', ['number', 'number']),
        sb = f('sqlite3_result_null', '', ['number']),
        Fc = f('sqlite3_result_text', '', [
          'number',
          'string',
          'number',
          'number',
        ]),
        Gc = f('sqlite3_result_blob', '', [
          'number',
          'number',
          'number',
          'number',
        ]),
        Hc = f('sqlite3_result_int', '', ['number', 'number']),
        tb = f('sqlite3_result_error', '', ['number', 'string', 'number']),
        hc = f('RegisterExtensionFunctions', 'number', ['number']);
      ...
      a.prototype.getBlob = function (h) {
        ...
        var l = sc(this.Qa, h);
        h = rc(this.Qa, h);
        for (var q = new Uint8Array(l), p = 0; p < l; p += 1) q[p] = y[h + p];
        return q;
      };
      ...
      a.prototype.getAsObject = function (h, l) {
        ...
        for (var q = {}, p = 0; p < l.length; p += 1) q[l[p]] = h[p];
        return q;
      };
      ...
      a.prototype.Cb = function (h) {
        for (var l = 0; l < h.length; l += 1) this.ub(h[l], l + 1);
        return !0;
      };
      ...
      a.prototype.freemem = function () {
        for (var h; void 0 !== (h = this.kb.pop()); ) oa(h);
      };
          ...
          for (h = []; 0 !== v(ja, 'i8'); ) {
            ...
            if (0 !== D) {
              ...
              for (null != l && z.bind(l); z.step(); )
                null === N &&
                  ((N = { columns: z.getColumnNames(), values: [] }),
                  h.push(N)),
                  N.values.push(z.get(null, q));
              z.free();
            }
          }
          return h;
      ...
      c.prototype.each = function (h, l, q, p, z) {
        ...
        h = this.prepare(h, l);
        try {
          for (; h.step(); ) q(h.getAsObject(null, z));
        } finally {
          h.free();
        }
      ...
      c.prototype.close = function () {
        null !== this.db &&
          (Object.values(this.eb).forEach(function (h) {
            h.free();
          }),
          Object.values(this.Wa).forEach(sa),
          (this.Wa = {}),
      ...
      c.prototype.create_function = function (h, l) {
        Object.prototype.hasOwnProperty.call(this.Wa, h) &&
          (sa(this.Wa[h]), delete this.Wa[h]);
        ...
        this.Wa[h] = q;
        this.handleError(yc(this.db, h, l.length, 1, 0, q, 0, 0, 0));
        return this;
      };
      e.Database = c;
    };
    var wa = {},
      B;
    for (B in e) e.hasOwnProperty(B) && (wa[B] = e[B]);
    var xa = './this.program',
      ...
      Ga;
    if (Ba)
      (E = za ? require('path').dirname(E) + '/' : __dirname + '/'),
        (Ca = function (a, b) {
          Fa || (Fa = require('fs'));
          Ga || (Ga = require('path'));
          a = Ga.normalize(a);
      ...
      za
        ...
        (E =
          0 !== E.indexOf('blob:') ? E.substr(0, E.lastIndexOf('/') + 1) : ''),
        (Ca = function (a) {
    ...
    for (B in wa) wa.hasOwnProperty(B) && (e[B] = wa[B]);
    wa = null;
    ...
    function va(a) {
      ...
      if (Ja.has(a)) a = Ja.get(a);
      else {
        if (Ia.length) b = Ia.pop();
        else {
          try {
            J.grow(1);
          } catch (g) {
        ...
        try {
          ...
          if ('function' === typeof WebAssembly.Function) {
            var d = { i: 'i32', j: 'i64', f: 'f32', d: 'f64' },
              f = { parameters: [], results: [] };
      ...
      switch (b) {
        ...
        case 'i64':
          L = [
            ...
            1 <= +Math.abs(M)
              ? 0 < M
                ? (Math.min(+Math.floor(M / 4294967296), 4294967295) | 0) >>> 0
    ...
    function hb() {
      var a = P;
      try {
        if (a == P && Ka) return new Uint8Array(Ka);
        if (Ea) return Ea(a);
    ...
    var Db = {
        ...
        read: function (a, b, c, d) {
          if (!a.tty || !a.tty.bb.zb) throw new Q(60);
    ...
    var R = {
            ...
            (R.Ua = {
              dir: {
                node: {
                  ...
                  unlink: R.La.unlink,
                  rmdir: R.La.rmdir,
                  readdir: R.La.readdir,
                  symlink: R.La.symlink,
                },
                stream: { Ya: R.Ma.Ya },
              },
              file: {
                node: { Ta: R.La.Ta, Sa: R.La.Sa },
                stream: {
                  Ya: R.Ma.Ya,
                  read: R.Ma.read,
                  write: R.Ma.write,
              ...
              link: {
                node: { Ta: R.La.Ta, Sa: R.La.Sa, readlink: R.La.readlink },
                stream: {},
              },
              vb: { node: { Ta: R.La.Ta, Sa: R.La.Sa }, stream: Ib },
            });
          c = Jb(a, b, c, d);
          S(c.mode)
            ? ((c.La = R.Ua.dir.node), (c.Ma = R.Ua.dir.stream), (c.Na = {}))
            : 32768 === (c.mode & 61440)
            ? ((c.La = R.Ua.file.node),
              (c.Ma = R.Ua.file.stream),
              (c.Ra = 0),
              (c.Na = null))
            : 40960 === (c.mode & 61440)
            ? ((c.La = R.Ua.link.node), (c.Ma = R.Ua.link.stream))
            : 8192 === (c.mode & 61440) &&
              ((c.La = R.Ua.vb.node), (c.Ma = R.Ua.vb.stream));
        ...
        La: {
          ...
          rename: function (a, b, c) {
            if (S(a.mode)) {
              ...
              if (d) for (var f in d.Na) throw new Q(55);
            }
        ...
        Ma: {
          ...
          write: function (a, b, c, d, f, g) {
            ...
            else for (g = 0; g < d; g++) a.Na[f + g] = b[c + g];
    ...
    function W(a, b) {
      ...
      if (8 < b.qb) throw new Q(32);
      a = ub(
        a.split('/').filter(function (m) {
          return !!m;
        }),
        !1
      );
    ...
    function Lb(a, b) {
      var c;
      if ((c = (c = Ub(a, 'x')) ? c : a.La.lookup ? 0 : 2)) throw new Q(c, a);
    ...
    function Zb(a, b, c) {
      ...
      if ((a = Ub(a, 'wx'))) return a;
      if (c) {
        if (!S(d.mode)) return 54;
        if (d === d.parent || '/' === Rb(d)) return 10;
      } else if (S(d.mode)) return 31;
      return 0;
    }
    function $b(a) {
      var b = 4096;
      for (a = a || 0; a <= b; a++) if (!T[a]) return a;
      throw new Q(33);
    }
    function ac(a, b) {
    ...
    function cc(a, b) {
      var c = '/' === b,
        d = !b;
      if (c && Mb) throw new Q(10);
      if (!c && !d) {
        var f = W(b, { xb: !1 });
        b = f.path;
        f = f.node;
        if (f.$a) throw new Q(10);
        if (!S(f.mode)) throw new Q(54);
      }
      b = { type: a, Sb: {}, Ab: b, Kb: [] };
      a = a.Va(b);
      a.Va = b;
    ...
    function ec(a, b) {
      if (!zb(a)) throw new Q(44);
      var c = W(b, { parent: !0 }).node;
      if (!c) throw new Q(44);
      b = xb(b);
      var d = Yb(c, b);
      if (d) throw new Q(d);
      if (!c.La.symlink) throw new Q(63);
      c.La.symlink(c, b, a);
    }
    function ua(a) {
      var b = W(a, { parent: !0 }).node,
        ...
        f = Zb(b, c, !1);
      if (f) throw new Q(f);
      if (!b.La.unlink) throw new Q(63);
      if (d.$a) throw new Q(10);
      try {
      ...
      Tb(d);
      try {
        if (V.onDeletePath) V.onDeletePath(a);
      } catch (g) {
        H(
    ...
    function Qb(a) {
      a = W(a).node;
      if (!a) throw new Q(44);
      if (!a.La.readlink) throw new Q(28);
      return zb(Rb(a.parent), a.La.readlink(a));
    }
    function fc(a, b) {
      a = W(a, { Xa: !b }).node;
      if (!a) throw new Q(44);
      if (!a.La.Ta) throw new Q(63);
      return a.La.Ta(a);
    }
    function gc(a) {
      return fc(a, !0);
    ...
    function ia(a, b, c, d) {
      ...
      if (b & 65536 && !S(g.mode)) throw new Q(54);
      if (
        !f &&
        (c = g
          ? 40960 === (g.mode & 61440)
            ? 32
            : S(g.mode) && ('r' !== Xb(b) || b & 512)
            ? 31
            : Ub(g, Xb(b))
          : 44)
      )
      ...
      !e.logReadFiles ||
        ...
        (Lc || (Lc = {}),
        a in Lc ||
          ((Lc[a] = 1), H('FS.trackingDelegate error on read file: ' + a)));
      try {
        V.onOpenFile &&
          ((g = 0),
          1 !== (b & 2097155) && (g |= 1),
    ...
    function Mc(a, b, c) {
      if (null === a.fd) throw new Q(8);
      if (!a.seekable || !a.Ma.Ya) throw new Q(70);
    ...
    function Nc(a, b, c, d, f) {
      ...
      if (S(a.node.mode)) throw new Q(31);
      if (!a.Ma.read) throw new Q(28);
    ...
    function ka(a, b, c, d, f, g) {
      ...
      m || (a.position += b);
      try {
        if (a.path && V.onWriteToFile) V.onWriteToFile(a.path);
      } catch (t) {
        H(
    ...
    function Tc(a, b, c) {
      try {
        ...
        if (f && f.node && r(b) !== r(Rb(f.node))) return -54;
        throw f;
      }
      K[c >> 2] = d.dev;
      K[(c + 4) >> 2] = 0;
    ...
    function Yc() {
      if (!Zc) {
        var a = {
          ...
          b;
        for (b in Xc) void 0 === Xc[b] ? delete a[b] : (a[b] = Xc[b]);
        var c = [];
    ...
    var ad = {
      ...
      E: function (a, b, c) {
        try {
          var d = T[a];
          if (!d) throw new Q(8);
          if (0 === (d.flags & 2097155)) throw new Q(28);
          Jc(d.node, c);
          return 0;
        } catch (f) {
          return ('undefined' !== typeof Y && f instanceof Q) || F(f), -f.Pa;
      ...
      p: function (a, b) {
        ...
        Yc().forEach(function (d, f) {
          var g = b + c;
          f = K[(a + 4 * f) >> 2] = g;
          for (g = 0; g < d.length; ++g) y[f++ >> 0] = d.charCodeAt(g);
          y[f >> 0] = 0;
          c += d.length + 1;
        });
        return 0;
    ...
    (function () {
      function a(f) {
        ...
        0 == cb &&
          (null !== db && (clearInterval(db), (db = null)),
          eb && ((f = eb), (eb = null), f()));
      }
      function b(f) {
        a(f.instance);
      ...
      if (e.instantiateWasm)
        try {
          ...
          return (
            H('Module.instantiateWasm callback failed with error: ' + f), !1
          );
        }
      (function () {
        return Ka ||
    ...
    e._sqlite3_bind_parameter_index = function () {
      return (e._sqlite3_bind_parameter_index = e.asm.ra).apply(
        null,
        arguments
      );
    };
    ...
    var ob = (e.__get_tzname = function () {
      ...
      x = (e.stackAlloc = function () {
        return (x = e.stackAlloc = e.asm.Ja).apply(null, arguments);
      }),
      ...
      function a() {
        if (!bd && ((bd = !0), (e.calledRun = !0), !Pa)) {
          e.noFSInit ||
            ...
            (e.stdout = e.stdout),
            (e.stderr = e.stderr),
            e.stdin ? Qc('stdin', e.stdin) : ec('/dev/tty', '/dev/stdin'),
            e.stdout
              ? Qc('stdout', null, e.stdout)
              : ec('/dev/tty', '/dev/stdout'),
            e.stderr
              ? Qc('stderr', null, e.stderr)
